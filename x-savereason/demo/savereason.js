...
$(function () {
  ...
  if (SR1.length > 0) {
    ...
    SR1.get(0).addReason({ range: '[2017-01-16T00:35:00Z,2017-01-16T12:00:00)' });
    SR1.load();
  }
  var SR2 = $('#SR_2');
  if (SR2.length > 0) {
    //xtag.addObserver(SR2.get(0), "inserted", function(){
    SR2.get(0).addReason({ range: '[2017-01-16T00:35:00Z,2017-01-16T12:00:00)' });
    SR2.load();
  }
  var SR3 = $('#SR_3');
  if (SR3.length > 0) {
    //xtag.addObserver(SR3.get(0), "inserted", function(){
    SR3.get(0).addReason({ range: '[2017-01-16T00:35:00Z,2017-01-16T10:00:00)' });
    SR3.get(0).addReason({ range: '[2017-01-16T10:00:00Z,2017-01-16T12:00:00)' });
    SR3.load();
  }
