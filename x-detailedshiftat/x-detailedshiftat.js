...
(function () {
  ...
  class DetailedShiftAtComponent extends pulseComponent.PulseParamAutoPathSingleRequestComponent {
    ...
    initialize () {
      ...
      let spanTitle = $('<span></span>').addClass('detailedshiftat-title-span')
        .html(title);
    ...
    validateParameters () {
      if ((!this.element.hasAttribute('machine-id'))
        ...
        console.error('missing attribute machine-id in detailedshiftat.element');
        // Delayed display :
    ...
    refresh (data) {
      ...
      if (display != '') {
        ...
        let spanRange = $('<span></span>').addClass('detailedshiftat-range-span')
          .html(rangeDisplay);
