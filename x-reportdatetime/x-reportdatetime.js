...
(function () {
  ...
  class ReportDateTimeComponent extends pulseComponent.PulseParamAutoPathSingleRequestComponent {
    ...
    _fillTypeCB () {
      ...
      optionCB.textContent = this.getTranslation('typeExplicit', 'From... to...');
      this._typeSelectCB.appendChild(optionCB);
      optionCB = document.createElement('option');
      optionCB.value = 'since';
      optionCB.textContent = this.getTranslation('typeSince', 'Since...');
      this._typeSelectCB.appendChild(optionCB);
      optionCB = document.createElement('option');
      optionCB.value = 'past';
      optionCB.textContent = this.getTranslation('typePast', 'Past');
      this._typeSelectCB.appendChild(optionCB);
      optionCB = document.createElement('option');
      optionCB.value = 'current';
      optionCB.textContent = this.getTranslation('typeCurrent', 'Current');
      this._typeSelectCB.appendChild(optionCB);
    }
    ...
    _fillPastCB () {
      ...
      let optionCB = document.createElement('option');
      optionCB.value = 'hour';
      optionCB.textContent = this.getTranslation('unitHours', 'hour(s)');
      optionCB.classList.add('hide-for-full-day');
      this._pastUnitCB.appendChild(optionCB);
      optionCB = document.createElement('option');
      optionCB.value = 'shift';
      optionCB.textContent = this.getTranslation('unitShifts', 'shift(s)');
      optionCB.classList.add('hide-for-full-day');
      this._pastUnitCB.appendChild(optionCB);
      optionCB = document.createElement('option');
      optionCB.value = 'day';
      optionCB.selected = true;
      optionCB.textContent = this.getTranslation('unitDays', 'day(s)');
      this._pastUnitCB.appendChild(optionCB);
      optionCB = document.createElement('option');
      optionCB.value = 'week';
      optionCB.textContent = this.getTranslation('unitWeeks', 'week(s)');
      this._pastUnitCB.appendChild(optionCB);
      optionCB = document.createElement('option');
      optionCB.value = 'month';
      optionCB.textContent = this.getTranslation('unitMonths', 'month(s)');
      this._pastUnitCB.appendChild(optionCB);
      optionCB = document.createElement('option');
      optionCB.value = 'quarter';
      optionCB.textContent = this.getTranslation('unitQuarters', 'quarter(s)');
      this._pastUnitCB.appendChild(optionCB);
      optionCB = document.createElement('option');
      optionCB.value = 'year';
      optionCB.textContent = this.getTranslation('unitYears', 'year(s)');
      this._pastUnitCB.appendChild(optionCB);
    ...
    _fillCurrentCB () {
      ...
      optionCB.textContent = this.getTranslation('current1Hour', '1 hour');
      optionCB.classList.add('hide-for-full-day');
      this._currentCB.appendChild(optionCB);
      optionCB = document.createElement('option');
      optionCB.value = '1_shift';
      optionCB.textContent = this.getTranslation('current1Shift', '1 shift');
      optionCB.classList.add('hide-for-full-day');
      this._currentCB.appendChild(optionCB);
      optionCB = document.createElement('option');
      optionCB.value = '1_day';
      optionCB.selected = true;
      optionCB.textContent = this.getTranslation('currentToday', 'today');
      this._currentCB.appendChild(optionCB);
      optionCB = document.createElement('option');
      optionCB.value = '2_day';
      optionCB.textContent = this.getTranslation('currentTodayYesterday', 'today + yesterday');
      this._currentCB.appendChild(optionCB);
      optionCB = document.createElement('option');
      optionCB.value = '1_week';
      optionCB.textContent = this.getTranslation('current1Week', '1 week');
      this._currentCB.appendChild(optionCB);
      optionCB = document.createElement('option');
      optionCB.value = '2_week';
      optionCB.textContent = this.getTranslation('current2Weeks', '2 weeks');
      this._currentCB.appendChild(optionCB);
      optionCB = document.createElement('option');
      optionCB.value = '1_month';
      optionCB.textContent = this.getTranslation('current1Month', '1 month');
      this._currentCB.appendChild(optionCB);
      optionCB = document.createElement('option');
      optionCB.value = '1_quarter';
      optionCB.textContent = this.getTranslation('current1Quarter', '1 quarter');
      this._currentCB.appendChild(optionCB);
      optionCB = document.createElement('option');
      optionCB.value = '1_year';
      optionCB.textContent = this.getTranslation('current1Year', '1 year');
      this._currentCB.appendChild(optionCB);
