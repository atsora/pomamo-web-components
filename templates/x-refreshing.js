...
(function () {
  ...
  class XXXComponent extends pulseComponent.PulseRefreshingComponent {
    /**
     * Constructor
     * 
     * @param  {...any} args 
    ...
    */
    ...
    get url () {
      ...
      let url = this.element.getAttribute('path') // OR maybe this.getConfigOrAttribute('path', '')
  ...
  pulseComponent.registerElement('x-XXX', XXXComponent, ['myattr']);
})();
