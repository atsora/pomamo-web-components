  ...
  class ShiftSlotBarComponent extends pulseComponent.PulseParamAutoPathRefreshingComponent {
    ...
    */
    ...
    initialize () {
      ...
      this._content = $('<div></div>').addClass('shiftslotbar-content pulse-bar-content');
    ...
    cleanContent () {
      ...
      $(this.element).find('.shiftslotbar-svg').remove(); // Remove Old SVG
    }
    ...
    displayError (text) {
      ...
      /*if (typeof this.content !== 'undefined') {
        this.content.find('.shiftslotbar-svg').remove();
      }*/
    }
