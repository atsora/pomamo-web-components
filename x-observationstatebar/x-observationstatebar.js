  ...
  class ObservationStateBarComponent extends pulseComponent.PulseParamAutoPathRefreshingComponent {
    ...
    */
    ...
    initialize () {
      ...
      this._content = $('<div></div>').addClass('observationstatebar-content pulse-bar-content');
    ...
    cleanContent () {
      ...
      $(this.element).find('.observationstatebar-svg').remove(); // Remove Old SVG
    }
    ...
    displayError (text) {
      ...
      /*if (typeof this.content !== 'undefined') {
        this.content.find('.observationstatebar-svg').remove();
      }*/
    }
