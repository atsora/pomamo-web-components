...
ATSORA_LOCALE_COMPONENT_CATALOG.default = {
  ...
  datetimerange: {
    ...
    fromNow: 'From now on, with no end',
  ...
  machineselection: {
    ...
    previewMachines: 'Preview machines',
    searchDots: 'Search...',
...
ATSORA_LOCALE_COMPONENT_CATALOG.fr = {
  ...
  machineselection: {
    ...
    previewMachines: 'Aperçu des machines',
...
ATSORA_LOCALE_COMPONENT_CATALOG.de = {
  ...
  machineselection: {
    ...
    previewMachines: 'Maschinenvorschau',
    searchDots: 'Suchen...',
